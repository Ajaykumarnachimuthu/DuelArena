          ...
          {tasks.slice(0, 8).map((t, i) => {
            ...
            return (
              <motion.div 
                ...
                className="group flex items-center justify-between p-3.5 border border-white/5 bg-white/[0.02] hover:bg-white/[0.05] transition-colors rounded-xl cyber-border"
              >
                <div className="flex items-center gap-4">
                  <div className={cn(
                    "w-9 h-9 rounded-xl flex items-center justify-center border",
                    isAjay ? "bg-brand-cyan/20 text-brand-cyan border-brand-cyan/30" : "bg-brand-pink/20 text-brand-pink border-brand-pink/30"
                  )}>
